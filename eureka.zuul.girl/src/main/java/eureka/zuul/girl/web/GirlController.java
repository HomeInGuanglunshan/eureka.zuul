...
import eureka.zuul.girl.service.GirlDbService;
...
public class GirlController {
	...
	public String sayHello() {
		return "Hello, I am a girl. [from girl]";
	}
	...
	public String wakeUpAfter(int millis) {
		...
		return "wake up after " + millis + " millis. [from girl]";
	}
